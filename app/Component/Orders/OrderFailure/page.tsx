...
import { AlertCircle, Phone, Mail, Home, ShoppingCart, ShieldAlert } from 'lucide-react';
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-red-100">
            ...
            <div className="bg-red-50 px-6 py-8 text-center border-b border-red-100">
              ...
              <h1 className="text-3xl font-black text-gray-900 mb-2">Order Processing Issue</h1>
              <p className="text-red-600 font-medium">Payment Received, but Order sync failed</p>
            </div>
            ...
            <div className="p-8">
              <div className="bg-orange-50 rounded-2xl p-6 mb-8 border border-orange-100">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-orange-900 mb-1">What happened?</h3>
                    <p className="text-orange-800 text-sm leading-relaxed">
                      Your payment of was successful, but there was a technical glitch while saving your order details. 
              ...
              <div className="space-y-6 mb-8">
                <div className="flex justify-between items-center py-4 border-b border-gray-100">
                  ...
                  <span className="text-gray-900 font-bold font-mono">{paymentId || 'N/A'}</span>
                </div>
                <div className="flex justify-between items-center py-4 border-b border-gray-100">
                  <span className="text-gray-500 font-medium">Error Details</span>
                  <span className="text-red-600 font-semibold text-right max-w-[200px] truncate">{error}</span>
                </div>
                <div className="flex justify-between items-center py-4 border-b border-gray-100">
              ...
              <div className="bg-gray-50 rounded-2xl p-6 mb-8">
                <h4 className="text-sm font-bold text-gray-900 mb-4 uppercase tracking-widest">Next Steps</h4>
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-lg bg-green-100 flex items-center justify-center">
                      <Phone className="w-4 h-4 text-green-600" />
                    </div>
                    <span className="text-gray-700 font-medium">+91 9112001140</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-lg bg-blue-100 flex items-center justify-center">
                      <Mail className="w-4 h-4 text-blue-600" />
                    </div>
                    <span className="text-gray-700 font-medium">support@kaveridesi.com</span>
                  </div>
                </div>
                <p className="mt-4 text-xs text-gray-500">
                  Please quote your Payment ID while contacting us for immediate resolution.
                </p>
              </div>
